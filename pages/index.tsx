...
function App() {
  const [date, updateDate] = useState<string | null>(() => {
    ...
    <div>
      ...
      <div id="datePicker">
        ...
        <DatePicker
          ...
          onChange={(e: unknown) => updateDate(convertPickerDate(e))}
        />
      </div>
      <div className="timeButtons">
        <Button
          text="&lt; Previous Day"
          handler={() => updateDate(jump1day(date, "back"))}
        />
        <Button text="Today" handler={() => updateDate(goToToday())} />
        <Button
          text="Next Day &gt;"
          handler={() => updateDate(jump1day(date, "forward"))}
        />
      </div>
